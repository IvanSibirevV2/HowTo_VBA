...
if IsArray(arr_name) then 'проверяем является ли переменная arr_name массивом
	...
	a = UBound(arr_name) 'присваеваем переменной a верхнюю границу (Получаем индекс и как разницу размер) (Номер последнего элемента) массива arr_name
	b = LBound(arr_name) 'присваеваем переменной b нижнюю границу (Получаем индекс и как разницу размер) (Номер первого элемента) массива arr_name
